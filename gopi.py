...
# spark.sql("select id,tdate,category,spendby from df where category ='Exercise' or spendby='cash'").show()
# spark.sql("select * from df where category in('Gymnastics','Exercise') ").show()
# spark.sql("select * from df where product like('%Gymnastics%')").show()
# spark.sql("select * from df where category != 'Exercise'").show()
# spark.sql("select * from df where category not in('Gymnastics','Exercise')").show()
...
# spark.sql("select amount,double(amount) as double from df ").show()
# spark.sql("select product,coalesce(product,'NA') as nullrep from df").show()
# spark.sql("select trim(product) as trim from df").show()
# spark.sql("select distinct category,spendby from df").show()
# spark.sql("select substring(product,1,4) as sub from df").show()
...
# spark.sql("select category,sum(amount) as amount from df group by category").show()
# spark.sql("select category,spendby,sum(amount) as amount from df group by category,spendby").show()
# spark.sql("select category,spendby,sum(amount) as amount,count(amount) as cnt from df group by category,spendby").show()
...
# spark.sql("select category,amount,dense_rank() over(partition by category order by amount desc) as dense from df").show()
